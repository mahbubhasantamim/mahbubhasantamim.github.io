  ...
  return (
    <>
      <div className="fixed bg-gray-600 w-full h-full top-0 left-0 z-50 bg-opacity-50 px-4">
        <div className="relative md:w-4/6 h-[90vh] mt-8 mx-auto px-8 py-14 bg-white z-10 rounded-md shadow-lg border-2 border-slate-500 animate-scale overflow-auto">
          <div
